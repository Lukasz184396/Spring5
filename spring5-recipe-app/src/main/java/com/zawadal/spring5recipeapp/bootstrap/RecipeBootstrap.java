package com.zawadal.spring5recipeapp.bootstrap;

import com.zawadal.spring5recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional
    // Spring will create a transaction around this method; everything will happen in the same transaction context;
